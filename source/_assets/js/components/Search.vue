<template>
    <div class="flex flex-1 justify-start items-center text-right px-4">
        <div
            class="absolute md:relative w-full justify-start bg-white left-0 top-0 z-10 mt-7 md:mt-0 px-4 md:px-0"
        ...
        >
            ...
            <input
                ...
                v-model="query"
                ref="search"
                class="transition-fast relative block h-10 w-full bg-gray-100 border border-gray-500 focus:border-blue-400 outline-none cursor-pointer text-gray-700 px-4 pb-0 pt-px"
